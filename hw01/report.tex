...
\usepackage{amsmath,tabularx,geometry,graphicx,multirow,tikz,listings,xcolor}
...
\lstdefinestyle{mystyle}{
  ...
  emph=[1]{scipy,io,arff,pandas,pd,DataFrame,sklearn,preprocessing,LabelEncoder,model_selection,feature_selection,SelectKBest,tree,DecisionTreeClassifier,metrics,functools,partial,matplotlib,pyplot,plt},
